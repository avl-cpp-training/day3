...
template<animal_id ANIMAL_ID> const std::wstring animal_name<ANIMAL_ID>::name = fail_name<ANIMAL_ID>();
...
template<> const std::wstring animal_name<sparrow_id>::name = L"sparrow";
template<> const std::wstring animal_name<cockroach_id>::name = L"cockroach";
template<> const std::wstring animal_name<tarantula_id>::name = L"tarantula";
